...
2. 运行本教程提供的“一键初始化 SQL 脚本”生成数据表。
3. 在代码最上方填入你的 `SUPABASE_URL` 和 `SUPABASE_KEY`。
4. （可选）配置你的自定义 SMTP 邮箱服务用于管理员注册。
5. 将最终的 HTML 文件直接丢进 Vercel、Netlify 或 GitHub Pages 即可免费上线。
